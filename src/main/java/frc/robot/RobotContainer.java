    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
            ...
            // )
                ...
                // Drivetrain will execute this command periodically
                drivetrain.applyRequest(() ->
                    driveAngle.withVelocityX(joystick.getLeftY() * MaxSpeed) // Drive forward with negative Y (forward)
                        .withVelocityY(joystick.getLeftX() * MaxSpeed) // Drive left with negative X (left)
                        .withTargetDirection(new Rotation2d(joystick.getRightX(), joystick.getRightY()).rotateBy(Rotation2d.kCCW_90deg)) // Drive counterclockwise with negative X (left)
                )
        );
        ...
        joystick.a().onTrue(drivetrain.getLeftCoralDriveCommand());
